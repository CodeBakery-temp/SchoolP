...
+(id) adminWithName: (NSString *)name lastName: (NSString *) lastName mailAddress: (NSString *)mailAddress phoneNumber:(NSString *)phoneNumber courses: (NSArray *) coursesTemp {
    return [[self alloc]initWithAdminName:name lastName:lastName mailAddress:mailAddress  phoneNumber:phoneNumber courses:coursesTemp];
}

-(id)init {
    return [self initWithAdminName:@"unknown" lastName: @"unknown"  mailAddress:@"unknown"  phoneNumber:@"0" courses:0];
}

-(id) initWithAdminName: (NSString *)name lastName: (NSString *) lastName mailAddress: (NSString *)mailAddress phoneNumber:(NSString *)phoneNumber courses: (NSArray *)coursesTemp {
    if(self = [super init])
    {
